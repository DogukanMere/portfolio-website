...
const ThemeSwitch = ({ setTheme, theme }: ThemeSwitchProps) => {
  return (
    <div className='fixed w-10 h-10 left-32 top-[1.3rem] sm:left-[4.2rem] group sm:top-[8rem] bg-bgDark dark:bg-bgLight rounded-full overflow-hidden cursor-pointer select-none' onClick={setTheme}>
