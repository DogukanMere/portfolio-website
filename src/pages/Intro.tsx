...
const Intro = () => {
  return (
    <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 1.5 }} className='min-h-screen flex flex-col xl:flex-row items-center justify-center gap-y-16 gap-x-0 sm:gap-x-36 relative'>
      {/* Img Container */}
      <a href='#about' className='overflow rounded-full w-[13rem] sm:w-[20rem] group order-1 xl:order-2 relative glow-item'>
      ...
      <div className='flex flex-col w-full sm:w-[20rem] md:w-[30rem] lg:w-[35rem] relative order-2 xl:order-1'>
        <h1 className='text-3xl md:text-5xl font-bold text-primaryDark opacity-80 dark:opacity-100 dark:text-bgLight whitespace-nowrap tracking-wide'>I AM DOGUKAN MERE,</h1>
